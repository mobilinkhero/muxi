                ...
                <tbody>
                    @forelse($users as $user)
                        <tr>
                            ...
                            <td>
                                <span
                                    style="font-family: monospace; color: #10B981; background: rgba(16, 185, 129, 0.1); padding: 0.2rem 0.5rem; border-radius: 4px;">
                            ...
                            <td>
                                @if($user->latitude && $user->longitude)
                                    <div style="display: flex; flex-direction: column; gap: 4px;">
                                        <div style="font-size: 0.9rem; color: #F59E0B; font-weight: bold;">
                                        ...
                                        <a href="https://www.google.com/maps?q={{ $user->latitude }},{{ $user->longitude }}"
                                            target="_blank" style="color: #3b82f6; font-size: 0.8rem; text-decoration: underline;">
                                            Open in Google Maps
                                        </a>
                                    </div>
                                @else
                            ...
                            <td>
                                ...
                                <div style="font-size: 0.75rem; color: var(--gray);">{{ $user->updated_at->format('h:i A') }}
                                </div>
                            </td>
                            <td>
