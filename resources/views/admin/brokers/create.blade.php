...
@section('title', 'Connect Node - Admin')

@section('content')
    <div class="h-reveal" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 3rem;">
        <div>
            <h1 style="font-weight: 900; font-size: 2.5rem; letter-spacing: -1px; margin: 0;">Connect Node</h1>
            <p style="color: #94A3B8; margin-top: 0.5rem;">Initialize new partner referral endpoint.</p>
        </div>
    ...
    <div class="h-card h-reveal" style="max-width: 650px; margin: 0 auto;">
        <h3
            ...
            <i class="fas fa-link" style="color: var(--h-primary);"></i> Connection Parameters
        </h3>
        ...
        <form action="{{ route('admin.brokers.store') }}" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" name="name" class="h-input" placeholder="e.g. Exness, XM, IC Markets" required>
            </div>

            <div class="form-group mb-4">
                <label class="h-label">Referral Endpoint URL</label>
                <input type="url" name="referral_link" class="h-input" placeholder="https://..." required>
            </div>

            <div class="form-group mb-4">
                <label class="h-label">Partner Brand Asset (Logo URL)</label>
                <input type="text" name="logo_path" class="h-input" placeholder="https://example.com/logo.png">
            </div>

            <div class="form-group mb-4">
                <label class="h-label">Tactical Briefing / Bonus Data</label>
                <textarea name="description" class="h-input" rows="3"
            ...
            <button type="submit" class="btn-primary-h"
                ...
                <i class="fas fa-plug"></i> Establish Connection
            </button>
        </form>
    </div>
